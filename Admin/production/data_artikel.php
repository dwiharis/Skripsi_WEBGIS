                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        $data = mysqli_query($koneksi,"SELECT * FROM data_artikel");
                        $no=1;
                        ...
                        echo "<td>".$artikel['isi_artikel']."</td>";
                        echo "<td>".$artikel['tgl_upload']."</td>";
                        
                        
                        ?>
                        <td>
                            <div class="table-data-feature">
                            <a href="form_edit_artikel.php?id_artikel=<?php echo $artikel['id_artikel'];?>">
                              <button type="submit" class="btn btn-success">Edit</button>
                            <i class="zmdi zmdi-edit"></i>
                             </button></a>&nbsp;
                            <a href="proses_hapus_artikel.php?id_artikel=<?php echo $artikel['id_artikel'];?>">
