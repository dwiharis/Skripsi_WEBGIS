              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  method="post" enctype="multipart/form-data" action="proses_tambah_deteksi.php">
                     
            
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 ">Nama Kecamatan</label>
                        <div class="col-md-6 col-sm-6 ">
                          <select id="kecamatan" class="form-control" name="nama_kecamatan">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <select id="kelurahan" class="form-control" name="nama_kelurahan">
                           <option value="" disabled="" selected="">-- Pilih Kelurahan --</option>
                              <?php
                                $query = mysqli_query($koneksi, "SELECT * FROM kelurahan INNER JOIN kecamatan ON kelurahan.id_kecamatan_fk = kecamatan.id_kecamatan order by kelurahan");
                                  while ($row = mysqli_fetch_array($query)) { ?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="last-name" name="jumlah_penderita" class="form-control">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="last-name" name="curah_hujan" class="form-control">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="last-name" name="kelembaban_suhu" class="form-control">
                        </div>
                      </div>
                                            <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Latitude
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="last-name" name="latitude" class="form-control">
                        </div>
                      </div>
                                            <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="last-name" name="longitude" class="form-control">
                        </div>
                      </div>
                        <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="last-name" name="tahun" class="form-control">
                        </div>
                      </div>
