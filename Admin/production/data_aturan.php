                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        $data = mysqli_query($koneksi,"SELECT * FROM matris");
                        $no=1;

                        while($aturan = mysqli_fetch_array($data)){
                        echo "<tr>";
                        ?>
                        ...
                        <?php
                        // echo "<td>".$no++."</td>";
                        //echo "<td>".$artikel['id_artikel']."</td>";
                        echo "<td>".$aturan['id_matris']."</td>";
                        echo "<td>".$aturan['id_deteksi']."</td>";
                        echo "<td>".$aturan['id_aturan']."</td>";
                        echo "<td>".$aturan['nilai']."</td>";
                        echo "<td>".$aturan['keterangan']."</td>";
                        
                        ?>
                        <td>
                            <div class="table-data-feature">
                            <a href="form_edit_aturan.php?id_matris=<?php echo $aturan['id_matris'];?>">
                              <button type="submit" class="btn btn-success">Edit</button>
                            <i class="zmdi zmdi-edit"></i>
                             </button></a>&nbsp;
                            <a href="proses_hapus_aturan.php?id_matris=<?php echo $aturan['id_matris'];?>">
